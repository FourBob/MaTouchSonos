...
4. **Kabel:** Den USB-C-Stecker **gerade** von hinten durch den Tunnel schieben und in die Buchse stecken.
   Das Gerät dabei so drehen, dass die Buchse zum Tunnel zeigt, also „oben“ am Display.
   Der Stecker verhindert danach, dass sich der Körper im Sockel mitdreht.
5. **Gerät einsetzen:** Körper in die Aufnahme drücken, bis der Rand des Bechers auf dem Absatz aufliegt.
