...
| **Couch-Modus:** aus ~1 m Entfernung ablesbar | Gehäuseplanung: Gerät steht auf dem Couchtisch, Blick flach von schräg oben | Größere Schrift für Titel/Interpret (48 px statt 20–28 px), weniger Zeilen (Album weglassen), Lautstärke und Zustand groß; umschaltbar im Ringmenü oder automatisch nach einigen Sekunden ohne Bedienung, bei Annäherung/Berührung wieder Detailansicht. Braucht ggf. einen größeren Schriftschnitt mit Umlauten (`tools/gen_fonts.sh`) |
